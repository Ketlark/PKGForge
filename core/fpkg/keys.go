...
// This file ports the RSA keysets and symmetric keys from LibOrbisPkg/Util/Keys.cs.
// These are the known public keys used for creating and verifying fPKGs.

// rsaKeyset holds RSA-2048 key components in big-endian format.
type rsaKeyset struct {
	PrivateExponent []byte // d
	Exponent1       []byte // d mod (p-1)
	Exponent2       []byte // d mod (q-1)
	PublicExponent  []byte // e
...
// FakeKeyset is used to encrypt the IMAGE_KEY entry.
// This is flatz's generated mount-image key for Fake PKGs.
var FakeKeyset = rsaKeyset{
	...
	PublicExponent: []byte{0x00, 0x01, 0x00, 0x01},
	Coefficient: []byte{
...
// PkgDerivedKey3Keyset is the RSA keyset for dk3_ (index 3).
// We have both public and private keys for this one.
...
// PkgPublicKeys are the RSA public key moduli used to encrypt various derived keys.
// Index 0: passcode, Index 1: EKPFS, Index 3: PKG digest.
var PkgPublicKeys = [][]byte{
	...
	nil, // 2: unused
	// 3: PKG digest (same as PkgDerivedKey3Keyset modulus)
	{
		0xd2, 0x12, 0xfc, 0x33, 0x5f, 0x6d, 0xdb, 0x83, 0x16, 0x09, 0x62, 0x8b, 0x03, 0x56, 0x27, 0x37,
		0x82, 0xd4, 0x77, 0x85, 0x35, 0x29, 0x39, 0x2d, 0x52, 0x6b, 0x8c, 0x4c, 0x8c, 0xfb, 0x06, 0xc1,
		0x84, 0x5b, 0xe7, 0xd4, 0xf7, 0xbc, 0xd2, 0x4e, 0x62, 0x45, 0xcd, 0x2a, 0xbb, 0xd7, 0x77, 0x76,
...
// FakeKeySeed marks our fPKG key (spells "FAKEFAKEFAKEFAKE").
var FakeKeySeed = []byte{
...
// KeystoneMACData is used to hash the second SHA256-HMAC in keystone.
